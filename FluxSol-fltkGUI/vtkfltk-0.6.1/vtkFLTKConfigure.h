...
#define VTK_FLTK_MAJOR_VERSION        @VTK_FLTK_MAJOR_VERSION@
#define VTK_FLTK_MINOR_VERSION        @VTK_FLTK_MINOR_VERSION@
#define VTK_FLTK_MICRO_VERSION        @VTK_FLTK_MICRO_VERSION@
#define VTK_FLTK_PATCH_VERSION        @VTK_FLTK_PATCH_VERSION@
#define VTK_FLTK_VERSION              "@VTK_FLTK_VERSION@"
#define VTK_FLTK_RPM_VERSION          "@VTK_FLTK_RPM_VERSION@"
...
// #cmakedefine VTK_FLTK_BUILD_DEBUG @VTK_FLTK_BUILD_DEBUG@
// #  if defined(_DEBUG)
...
// #cmakedefine VTK_FLTK_BUILD_SHARED_LIBS
