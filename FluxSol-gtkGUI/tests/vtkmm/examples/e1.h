...
class MainWindow : public Gtk::Window
{
	...
	/////////////////////////////////
	//for vtk
	vtkSphereSource *_p_sphereSource;
	vtkElevationFilter *_p_elevationFilter;
	vtkDataSetMapper *_p_dataSetMapper;
	vtkActor *_p_sphereActor;
	vtkConeSource *_p_coneSource;
	vtkGlyph3D *_p_glyph;
	vtkPolyDataMapper *_p_spikeDataMapper;
	vtkActor *_p_spikeActor;
	vtkLight *_p_light;
	/////////////////////////////////
