...
set PKG_CONFIG_PATH=D:/Luciano/Programas/msys64/mingw64/lib/pkgconfig

cmake -G "CodeBlocks - MinGW Makefiles" -DCMAKE_CC_COMPILER=%CC% -DCMAKE_CXX_COMPILER=%CXX% -DCMAKE_BUILD_TYPE=RELEASE %FLUXSOL_DIR%/FluxSol-GUI
